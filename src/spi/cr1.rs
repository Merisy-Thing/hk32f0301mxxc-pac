...
#[doc = "Field `RXONLY` reader - Receive only mode enabled"]
pub type RXONLY_R = crate::BitReader;
#[doc = "Field `RXONLY` writer - Receive only mode enabled"]
...
#[doc = "Field `CRCNEXT` reader - Transmit CRC next"]
pub type CRCNEXT_R = crate::BitReader;
#[doc = "Field `CRCNEXT` writer - Transmit CRC next"]
...
impl R {
    ...
    #[doc = "Bit 10 - Receive only mode enabled"]
    #[inline(always)]
