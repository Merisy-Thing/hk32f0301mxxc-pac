...
#[doc = "DR4\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dr4::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DR4rs;
impl crate::RegisterSpec for DR4rs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dr4::R`](R) reader structure"]
impl crate::Readable for DR4rs {}
#[doc = "`reset()` method sets DR4 to value 0"]
impl crate::Resettable for DR4rs {
