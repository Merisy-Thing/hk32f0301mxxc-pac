...
#[doc = "DR5\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dr5::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DR5rs;
impl crate::RegisterSpec for DR5rs {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dr5::R`](R) reader structure"]
impl crate::Readable for DR5rs {}
#[doc = "`reset()` method sets DR5 to value 0"]
impl crate::Resettable for DR5rs {
