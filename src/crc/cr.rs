...
#[doc = "Field `RESET` reader - Reset control"]
pub type RESET_R = crate::BitReader;
#[doc = "Field `RESET` writer - Reset control"]
pub type RESET_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `REV_IN` reader - Input data revert"]
pub type REV_IN_R = crate::FieldReader;
#[doc = "Field `REV_IN` writer - Input data revert"]
pub type REV_IN_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `REV_OUT` reader - Output data revert"]
pub type REV_OUT_R = crate::BitReader;
#[doc = "Field `REV_OUT` writer - Output data revert"]
pub type REV_OUT_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - Reset control"]
    #[inline(always)]
    pub fn reset(&self) -> RESET_R {
        RESET_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bits 5:6 - Input data revert"]
    #[inline(always)]
    pub fn rev_in(&self) -> REV_IN_R {
        REV_IN_R::new(((self.bits >> 5) & 3) as u8)
    }
    #[doc = "Bit 7 - Output data revert"]
    #[inline(always)]
