...
#[doc = "Field `IDR` reader - General purpose 8-bit data register"]
pub type IDR_R = crate::FieldReader;
#[doc = "Field `IDR` writer - General purpose 8-bit data register"]
pub type IDR_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - General purpose 8-bit data register"]
    #[inline(always)]
