...
#[doc = "Field `SADD` reader - Slave address bit 9:0 in master mode"]
pub type SADD_R = crate::FieldReader<u16>;
#[doc = "Field `SADD` writer - Slave address bit 9:0 in master mode"]
...
#[doc = "Field `ADD10` reader - Addressing mode 10-bit，master mode"]
pub type ADD10_R = crate::BitReader;
#[doc = "Field `ADD10` writer - Addressing mode 10-bit，master mode"]
pub type ADD10_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `HEAD10R` reader - Address header only read direction 10-bit ,master receiver mode"]
pub type HEAD10R_R = crate::BitReader;
#[doc = "Field `HEAD10R` writer - Address header only read direction 10-bit ,master receiver mode"]
...
impl R {
    #[doc = "Bits 0:9 - Slave address bit 9:0 in master mode"]
    #[inline(always)]
    ...
    #[doc = "Bit 11 - Addressing mode 10-bit，master mode"]
    #[inline(always)]
    pub fn add10(&self) -> ADD10_R {
        ADD10_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bit 12 - Address header only read direction 10-bit ,master receiver mode"]
    #[inline(always)]
